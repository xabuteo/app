...
def render_sidebar_widgets():
    ...
    with st.sidebar.expander("🧪 Testing Checklist", expanded=True):
        data = [
            ...
            (20, "View event", "Select Register (option hidden)", "You won't be able to register as the status is pending"),
            (21, "Approve event", "Click on Admin", ""),
            (22, "Approve event", "Click on Approve", "Restricted to approvers"),
            ...
            (26, "Register for event", "Click on button to Populate Test Competitors", ""),
            (27, "Setup event", "Click on Admin", ""),
            (28, "Setup event", "Select competition and update a couple of seeds", ""),
            ...
            (37, "Run event", "Click on Admin tab to enter and save scores or click simulate scores", "Simulate only used for testing"),
